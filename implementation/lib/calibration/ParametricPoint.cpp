...
ParametricPoint ParametricPoint::onPlane(Eigen::Matrix<double, 3, 1> origin, const Eigen::Matrix<double, 3, 1> &axisA,
...
ParametricPoint
ParametricPoint::onLine(const Eigen::Matrix<double, 2, 1> &expectedPixel, Eigen::Matrix<double, 3, 1> origin, const
...
ParametricPoint ParametricPoint::onLine(Eigen::Matrix<double, 3, 1> origin, const Eigen::Matrix<double, 3, 1> &heading,
										double lambda) {
