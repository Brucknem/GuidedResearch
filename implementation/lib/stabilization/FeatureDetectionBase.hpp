...
namespace providentia {
	namespace stabilization {
		namespace features {
			 ...
			 */
			class SIFTFeatureDetector : public FeatureDetectionBase {
			private:
				/**
			 ...
			 * Wrapper for the CUDA SURF feature detector.
			 */
			class SURFFeatureDetector : public FeatureDetectionBase {
			private:
				/**
			 ...
			 * Wrapper for the CUDA SURF feature detector.
			 */
			class ORBFeatureDetector : public FeatureDetectionBase {
			private:
				/**
			 ...
			 * Wrapper for the CUDA SURF feature detector.
			 */
			class FastFREAKFeatureDetector : public FeatureDetectionBase {
			private:
				/**
			 ...
			 * Wrapper for the CUDA SURF feature detector.
			 */
			class StarBRIEFFeatureDetector : public FeatureDetectionBase {
			private:
				/**
				 * The CUDA FastFeature detector used to detect keypoints and descriptors.
				 */
