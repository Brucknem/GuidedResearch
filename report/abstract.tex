...
Second we propose an online Bundle Adjustment formulation based on the reprojection-error to statically calibrate separate RGB-only cameras \wrt{} a high definition map and to mitigate drift of the intrinsic and extrinsic camera parameters over time.
...
We derive the minimal number of correspondences needed between the video stream and the map, the structure they have to exceed and give lower bounds on the remaining calibration errors. 
