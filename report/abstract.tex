...
Second we propose an online reprojection-error based algorithm to statically calibrate RBG-only cameras \wrt{} a high definition map and to mitigate drift of the extrinsic camera parameters over time.
