...
For the FAST detector it shows that except for the \camsf{4} camera only between $67.2\%$ to $79.4\%$ of frames are more stable, whereas a value of $50\%$ does not directly indicate that the other $50\%$ of frames are worse as pointed out in \autoref{sec:dynamic_stabilization_evaluation_optical_flow_problem}.  
